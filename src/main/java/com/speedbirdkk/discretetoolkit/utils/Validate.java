...
import com.speedbirdkk.discretetoolkit.model.Matrix;
...
public final class Validate {
    ...
    public static <A> boolean irreflexivity(Set<A> domain, Set<Pair<A, A>> relationSet) {
        return domain.stream()
            .noneMatch(x -> relationSet.contains(new Pair<>(x, x)));
    }
    ...
    public static <A> boolean irreflexivity(Relation<A, A> relation) {
        return irreflexivity(relation.domain(), relation.relationSet());
    }
